...
| ---------------- | ----------------------- | --------------- | ------------- | ---------------: | -----------------: | ---------: | :-----: |
| gemm_test_01.txt | 10x10 10x10                     | Result Matrix   | Result Matrix |              ... |                ... |        ... | ✅ Pass |
| gemm_test_02.txt | 100x100 100x100                     | Result Matrix   | Result Matrix |              ... |                ... |        ... | ✅ Pass |
| gemm_test_03.txt | 500x500 500x500                     | Result Matrix   | Result Matrix |              ... |                ... |        ... | ✅ Pass |
| gemm_test_04.txt | 1000x1000 1000x100                     | Result Matrix   | Result Matrix |              ... |                ... |        ... | ✅ Pass |
