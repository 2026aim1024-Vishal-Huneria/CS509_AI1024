...
|--------------|----------------|---------:|--------:|-------:|----------------|-----------------|---------------|-----:|--------|
| Bellman-Ford | `bf_10.txt`    | 10       | 40     | 0      | No             | Distances       | Distances           | 0.001 ms | Pass |
| Bellman-Ford | `bf_100.txt`   | 100      | 400     | 0      | No             | Distances       | Distances           | 0.003 ms | Pass |
| Bellman-Ford | `bf_10000.txt` | 10,000   | 40,000     | 0      | No             | Distances       | Distances           | 0.164 ms | Pass |
| Bellman-Ford | `bf_50000.txt` | 50,000   | 1,00,000     | 0      | No             | Distances       | Distances           | 0.483 ms | Pass |
| Bellman-Ford | `bf_100000.txt`| 100,000  | 4,00,000     | 0      | No             | Distances       | Distances           | 1.126 ms | Pass |
